...
## Supported By
If you want to quickly add secure authentication to PHP apps and APIs, feel free to check out Auth0's PHP SDK and free plan at <a href=https://auth0.com/overview?utm_source=GHsponsor&utm_medium=GHsponsor&utm_campaign=codeigniter-ion-auth&utm_content=auth" target="_blank">auth0.com/overview</a><img src="http://download.phptownhall.com/auth0.png" height="25" />
