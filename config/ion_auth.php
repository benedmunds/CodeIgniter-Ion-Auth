...
/*
 ...
 | $config['admin_group'] = Default administrators group, use name
 | $config['identity'] = A database column which is used to login with
 | $config['min_password_length'] = Minimun required length of password
 | $config['max_password_length'] = Maximum allowed length of password
 | $config['email_activation'] = Email activation for registration
 | $config['manual_activation'] = Manual activation for registration
 | $config['remember_users'] = Allow users to be remembered and enable auto-login
 | $config['user_expire'] = How long to remember the user (seconds). Set to zero for no expiration
 | $config['user_extend_on_login'] = Extend the users cookies every time they auto-login
 | $config['track_login_attempts'] = Track the number of failed login attempts for each user or IP.
 | $config['track_login_ip_address'] = Track login attempts by IP address, if FALSE will track based on identity. (Default: TRUE)
 | $config['maximum_login_attempts'] = the maximum number of failed login attempts.
 | $config['lockout_time'] = The number of seconds to lockout an account due to exceeded attempts
 | $config['forget_password_expiration'] = The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
 | -------------------------------------------------------------------------
 */
...
/*
 ...
 | Explanation of the variables
 | -------------------------------------------------------------------------
 | $config['delimiters_source'] = "config" = use the settings defined here, "form_validation" = use the settings defined in CI's form validation library
